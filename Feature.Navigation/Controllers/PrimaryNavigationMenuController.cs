...
{
	public class PrimaryNavigationMenuController : ConventionController
	{
		#region Constructor
		public PrimaryNavigationMenuController(IViewPathResolver viewPathResolver, IDeclaredNavigationRepository repository, ICacheManager cache) : base(viewPathResolver)
		{
